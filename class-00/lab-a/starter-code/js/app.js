...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT - The console log is not necessary. Also, const is defined for the block that it is in, and therefore will not work outside of the block.
  console.log(viewed);
